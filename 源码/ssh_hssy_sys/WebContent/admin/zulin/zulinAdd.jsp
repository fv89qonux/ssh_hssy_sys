...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function c()
           {
               if(document.formAdd.goodsId.value=="")
               { 
                   alert("请选择婚纱");
                   return false;
               }
		   ...
		   {
		       	var strUrl = "<%=path %>/goodsSelect.action";
			    ...
			    document.getElementById("goodsId").value=ret;
		   }
				     ...
				     <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="goodsId" id="goodsId" readonly="readonly" style="width: 200px;"/>
						        <input type="button" value="选择" onclick="goodsSelect()"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="25%" bgcolor="#FFFFFF" align="right">
